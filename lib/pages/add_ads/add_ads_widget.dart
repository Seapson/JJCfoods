...
import 'add_ads_model.dart';
export 'add_ads_model.dart';

class AddAdsWidget extends StatefulWidget {
  const AddAdsWidget({super.key});
...
class _AddAdsWidgetState extends State<AddAdsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddAdsModel());
  }
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await FoodBannerRecord.collection
                            .doc()
                            .set(createFoodBannerRecordData(
