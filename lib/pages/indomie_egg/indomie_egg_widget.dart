...
import 'indomie_egg_model.dart';
export 'indomie_egg_model.dart';

class IndomieEggWidget extends StatefulWidget {
  const IndomieEggWidget({super.key});

  @override
  State<IndomieEggWidget> createState() => _IndomieEggWidgetState();
}

class _IndomieEggWidgetState extends State<IndomieEggWidget>
    with TickerProviderStateMixin {
  late IndomieEggModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IndomieEggModel());
    ...
    _model.switchValue6 = FFAppState().Salad;
                  ...
                  onSwipeFn: (index) async {
                    ...
                    await currentUserReference!.update({
                      ...mapToFirestore(
                        {
                          'CheckoutAmount':
                              FieldValue.increment(FFAppState().ProductPrice),
                          'NumberOfOrders': FieldValue.increment(1),
                        },
                      ),
                    });

                    await OrderedRecord.collection
                        .doc()
                        .set(createOrderedRecordData(
                          name: currentUserDisplayName,
                          price: FFAppState().ProductPrice,
                          createdAt: getCurrentTimestamp,
                          ticketCode: random_data.randomString(
                            5,
                            10,
                            true,
                            true,
                          ...
                          noodles: FFAppState().NumberOfNoodles,
                          eggs: FFAppState().NumberOfEggs,
                          plantain: FFAppState().NumberPlantain,
                          chicken: FFAppState().NumberOfChicken,
                          salad: FFAppState().Salad,
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        ...
                        backgroundColor: Color(0xFF1A861E),
                      ),
                    );
                    Navigator.push(
                      context,
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Align(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child: SelectionArea(
                                                                            child: Text(
                                                                          'Swipe or click cart button below to add to cart',
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
                                                                              .override(
                                                                                fontFamily: 'Poppins',
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  if (valueOrDefault<bool>(currentUserDocument?.isJJCadmin, false))
                                                                                        ...
                                                                                        Row(
                                                                                          ...
                                                                                          children: [
                                                                                            Align(
                                                                                              alignment: AlignmentDirectional(0.0, 0.0),
                                                                                              child: Text(
                                                                                                'Noodles (${formatNumber(
                                                                                                  containerProductListRecord?.supremeNoodlesPrice,
                                                                                                  formatType: FormatType.decimal,
                                                                                                  decimalType: DecimalType.periodDecimal,
                                                                                                  currency: 'NGN ',
                                                                                                )})',
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  if (valueOrDefault<bool>(currentUserDocument?.isJJCadmin, false))
                                                                                    AuthUserStreamWidget(
                                                                                      builder: (context) => Switch.adaptive(
                                                                                        value: _model.switchValue2 ??= containerProductListRecord!.egg,
                                                                                        onChanged: (newValue) async {
                                                                                        ...
                                                                                        Row(
                                                                                          ...
                                                                                          children: [
                                                                                            Align(
                                                                                              alignment: AlignmentDirectional(0.0, 0.0),
                                                                                              child: Text(
                                                                                                'Fried Eggs (${formatNumber(
                                                                                                  containerProductListRecord?.eggPrice,
                                                                                                  formatType: FormatType.decimal,
                                                                                                  decimalType: DecimalType.periodDecimal,
                                                                                                  currency: 'NGN ',
                                                                                                )})',
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  if (valueOrDefault<bool>(currentUserDocument?.isJJCadmin, false))
                                                                                    AuthUserStreamWidget(
                                                                                      builder: (context) => Switch.adaptive(
                                                                                        value: _model.switchValue3 ??= containerProductListRecord!.plantain,
                                                                                        onChanged: (newValue) async {
                                                                                        ...
                                                                                        Row(
                                                                                          ...
                                                                                          children: [
                                                                                            Align(
                                                                                              alignment: AlignmentDirectional(0.0, 0.0),
                                                                                              child: Text(
                                                                                                'Plantain (${formatNumber(
                                                                                                  containerProductListRecord?.plantainPrice,
                                                                                                  formatType: FormatType.decimal,
                                                                                                  decimalType: DecimalType.periodDecimal,
                                                                                                  currency: 'NGN ',
                                                                                                )})',
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  if (valueOrDefault<bool>(currentUserDocument?.isJJCadmin, false))
                                                                                    AuthUserStreamWidget(
                                                                                      builder: (context) => Switch.adaptive(
                                                                                        value: _model.switchValue4 ??= containerProductListRecord!.chicken,
                                                                                        onChanged: (newValue) async {
                                                                                        ...
                                                                                        Row(
                                                                                          ...
                                                                                          children: [
                                                                                            Align(
                                                                                              alignment: AlignmentDirectional(0.0, 0.0),
                                                                                              child: Text(
                                                                                                'Chicken (${formatNumber(
                                                                                                  containerProductListRecord?.chickenPrice,
                                                                                                  formatType: FormatType.decimal,
                                                                                                  decimalType: DecimalType.periodDecimal,
                                                                                                  currency: 'NGN ',
                                                                                                )})',
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  if (valueOrDefault<bool>(currentUserDocument?.isJJCadmin, false))
                                                                                    AuthUserStreamWidget(
                                                                                      builder: (context) => Switch.adaptive(
                                                                                        value: _model.switchValue5 ??= containerProductListRecord!.salad,
                                                                                        onChanged: (newValue) async {
                                                                                        ...
                                                                                        Row(
                                                                                          ...
                                                                                          children: [
                                                                                            Align(
                                                                                              ...
                                                                                              child: Text(
                                                                                                'Salad (${formatNumber(
                                                                                                  containerProductListRecord?.saladPrice,
                                                                                                  formatType: FormatType.decimal,
                                                                                                  decimalType: DecimalType.periodDecimal,
                                                                                                  currency: 'NGN ',
                                                                                                )})',
                                                                                  ...
                                                                                  Padding(
                                                                                    ...
                                                                                    child: Container(
                                                                                      ...
                                                                                      child: Switch.adaptive(
                                                                                        ...
                                                                                        onChanged: (containerProductListRecord?.salad == false)
                                                                                            ? null
                                                                                            : (newValue) async {
                                                                                                safeSetState(() => _model.switchValue6 = newValue!);
                                                                                                if (newValue!) {
                                                                                                  FFAppState().Salad = true;
                                                                                                  safeSetState(() {});
                                                                                                  FFAppState().ProductPrice = FFAppState().ProductPrice + containerProductListRecord!.saladPrice;
                                                                                                  safeSetState(() {});
                                                                                                } else {
                                                                                                  FFAppState().Salad = false;
                                                                                                  safeSetState(() {});
                                                                                                  FFAppState().ProductPrice = FFAppState().ProductPrice + functions.returncartprice(containerProductListRecord!.saladPrice);
                                                                                                  safeSetState(() {});
                                                                                                }
                                                                                              },
                                                                                        activeColor: FlutterFlowTheme.of(context).primary,
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    icon: Icon(
                                                                      ...
                                                                      color: FFAppState().AddedtoFavorite ==
                                                                              false
