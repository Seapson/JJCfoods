...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFD30000);
  late Color secondary = const Color(0xFFD23604);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFEADFE0);
  ...
  late Color overlay = Color(0xFFFBDDA4);
}
